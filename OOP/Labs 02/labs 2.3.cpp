/*
Define a class `Circle` where the following information is stored:
...
Define a class `Canvas` where the following information is stored:
...
- Prints in the format:
Canvas {name} with {num_of_circles} circles:

// Prints all circles in the canvas

All variables inside the classes should be private. Appropriately define within the classes:

- constructor (without and with parameters)
- destructor
- set methods
- get methods
- copy constructor
...
- Prints the canvas whose circles have the largest area.
