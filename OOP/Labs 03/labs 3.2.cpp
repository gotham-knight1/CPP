/*
To define a class `Employee` that stores information about:
...
Next, define a class `Department` to store information about:
...
Additionally, add a method in the `Department` class that checks whether there are two employees with the same ID number.

Note: The provided text does not specify the names of the classes' member 
functions (getters, setters, or others). You may add them based on your requirements.
*/
